...
urlpatterns = [
    ...
    path('<int:id>/outfit/alllist/', views.outfit_list_all),
    # 친구가 내꺼 코디한거 GET
    path('<int:id>/outfit/friendlist/', views.outfit_list_friend),

    # 직접 코디한 outfit 수정(GET/PATCH/DELETE) -- 여기서 id = 수정, 삭제하려는 사람의 아이디
    ...
    # 일주일치 옷 추천 ('POST'),GET
    path('weekRecommend/<int:id>/<season>/', views.week_recommendation),
    path('getSetRec/', views.rec_set),
